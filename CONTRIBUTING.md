# Contributing to cm4ai-metadata-model-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cm4ai-metadata-model-linkml. These guidelines are not strict rules.
...
The cm4ai-metadata-model-linkml team strives to create a
...
[issues]: https://github.com/cm4ai-uva/cm4ai-metadata-model-linkml/issues/
[pulls]: https://github.com/cm4ai-uva/cm4ai-metadata-model-linkml/pulls/
